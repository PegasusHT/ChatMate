    ...
    <div className="bg-blue-white w-1/3 pt-4 flex flex-col">
      <div className="flex-grow">
        ...
        {Object.keys(onlinePeopleExclOurUser).map(userId => (
          <Contact
            key={userId} id={userId}
            online={true} username={onlinePeopleExclOurUser[userId]}
        ...
        {Object.keys(bots).map(botId => (
          <BotSimi bots={bots} botId={botId}
            selectedBotId={selectedUserId}
            setSelectedBotId={setSelectedUserId} />
        ))}
      </div>
